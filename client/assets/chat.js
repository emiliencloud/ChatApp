...
// Action quand on clique sur le menu jeu
$('#open-game-menu').click(openGameMenu);
$('.close-game-menu').click(openGameMenu);
$('.start-aim-game').click(openGameMenu);
$('.header-btn-infos').click(openGameMenu);
$('#cross-aim-game').click(endAimGame);
$('.header-btn-infos').click(displayFeatures);
 ...
 */
 function displayAimGame() 
 {
	...
	$('.start-aim-game').prop("disabled",true);
...
function removeAimeGame() {
	...
	$('.start-aim-game').prop("disabled",false);
}
...
/**
 * Ouvre le menu jeux au clique
*/
function openGameMenu() {
	$('.responsive-nav').toggleClass('bottom-game-menu');
}
/**
 * Ouvre le menu infos au clique
*/
function displayFeatures() {
	$('#features').toggleClass('display-features');
}